...
@click.option('--syn-muts-table', type=click.Path(exists=True), help='Path to table of observed synonymous mutations per gene file. We recommend: syn_muts_per_gene.tsv')
